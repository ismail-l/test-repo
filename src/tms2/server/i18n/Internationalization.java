...
{
	private static final TMSConstants _constants = ConstantsFactory.createInstance(TMSConstants.class);
	private static final TMSMessages _messages = MessagesFactory.createInstance(TMSMessages.class);
