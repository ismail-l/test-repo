...
/**
 * A class to implement com.google.gwt.i18n.client.Constants derived interfaces
...
public class ConstantsFactory
{
	...
	public static <T extends com.google.gwt.i18n.client.Constants> T createInstance(Class<T> cls)
	{
		return (T) Proxy.newProxyInstance(MessagesFactory.class.getClassLoader(),
				new Class[] { cls },
				new ConstantsInvocationHandler(cls));
	}

	protected static class ConstantsInvocationHandler<T extends com.google.gwt.i18n.client.Constants>
			implements InvocationHandler
	{
		protected Class<T> cls;
		protected static Properties _properties = null;

		public ConstantsInvocationHandler(Class<T> cls)
		{
			this.cls = cls;
				...
				throws Throwable
		{
			...
			{
				object = method.getAnnotation(DefaultStringValue.class).value();
			}
