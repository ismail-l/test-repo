 ...
 *
 */
public interface UserCategoryServiceAsync 
{
	void updateUserCategory(String authToken, UserCategory userCategory, AsyncCallback<Result<UserCategory>> callback);	
